---
name: stealth-background-execution
description: "Build fully invisible WinExe background execution for C# apps with ApplicationContext lifecycle and silent crash recovery. Use to avoid flicker or popups in accessibility workflows."
---
