...
| Chrome was closed manually with X and next launch is stuck | End `YouTubeControl.exe` from Task Manager or restart your computer  and launch again; this should resolve the stale state and allow normal operation to resume |
